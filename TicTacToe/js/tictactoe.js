...
function placeXOrO(squareNumber) {
  ...
  //the .some() method is used to check element of the selectSquare array.
  //to see if it contains the square nmuber clicked on.
  if(!selectedSquares.some(element => element.includes(squareNumber))){
    ...
    //squareNumber and activePlayer are concatenated toghether and added to array.
...
//This function parses the selectSquares array to search for win coditions.
//drawLine() function is called to draw a line on the screen if the condition met.
function checkWinConditions() {
  ...
  //O 0,  1, 2 condition
   ...
   //O 3,  4, 5 condition
  else if(arrayIncludes('3O', '4O' , '5O')) {drxawWinLine(50, 304, 558, 304)}
   //O 6,  7, 8 condition
  ...
  //This condition checks for a tie. If none of the above conditions are met and  9 squares are selected the code excutes.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2){
  ...
  //This line gives us access to methods and properties to us on canvas.
  ...
  function animateLineDrawing() {
    ...
    c.beginPath();
    //This metohd moves us to a strating point in our line.
    c.moveTo(x1 , y1);
    ...
    if (x1 <= x2 && y1 <= y2) {
      ...
      if (x < x2) {x += 10; }
      //This condition add 10 to the previous end y point.
      if (y < y2) {y += 10; }
  ...
  //This function clears our canvas after our win line id drawn.
  function clear() {
