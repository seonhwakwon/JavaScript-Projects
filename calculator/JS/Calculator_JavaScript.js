//creation an object to keep track of values.
const Calculator = {
  //This will dispaly 0 on the calculation screen.
  Display_Value:'0',
...
function Handle_Operator(Next_Operator) {
  ...
  //Checks if an operator aleady exists and if Wait_Second_Operand is true,
...
keys.addEventListener('click', (event) => {
  //The traget variable is an object that represents the element
  //that was clicked
  const {target} = event;
